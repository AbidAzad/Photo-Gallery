...
public class HomeScreenController {
	 ...
	 * @param user for the user that holds the album data.
	 * @author AbidAzad aa2177
	 */	
	 ...
	 * @param event for the ActionEvent of the button being pushed.
	 * @author AbidAzad aa2177
	 */		
	 ...
	 @FXML void search(ActionEvent event) {
		 ...
		 if(searchOptions.getSelectionModel().getSelectedItem().toString().equals("Tags")) {
								 ...
								 for(Photo y : x.getPhotos()) {
									 ...
									 for(Tag z : y.getTags()) {
										 if(z.getValue().equals(tag1Value.getText()) && z.getTagType().equals(firstOptions.getSelectionModel().getSelectedItem().toString())) 
											 a = true;
										 if(z.getValue().equals(tag2Value.getText()) && z.getTagType().equals(thirdOptions.getSelectionModel().getSelectedItem().toString()))
											 b = true;
			 ...
			 if(searchResults.getPhotos().isEmpty()) {
				 Manager.showAlert("Error", "No results were found", "There were no results found with these parameters");
				 return;
			 }
			 try {		
  				FXMLLoader loader = new FXMLLoader();   
	  ...
	  /**
	   	 ...
	   	 * @param title for the title of alert, String.
	   	 * @param header for the header of alert, String.
	   	 * @param content for the content of alert, String.
	   	 * @author DiegoCastellanos dac392
	   	 */	      
