...
public class AlbumEditorController {
     ...
     * @param edit Edit to see if the album is being edited or added to.
     * @param user for the user that owns the album.
     * @param x for the album being edited.
     * @author AbidAzad aa2177
     */
     ...
     * @param event for the actionEvent of the button click.
     * @author AbidAzad aa2177
     */	
    ...
    /**
   	 ...
   	 * @param content String the actual message of alert.
   	 * @author DiegoCastellanos dac392
   	 */	  	
