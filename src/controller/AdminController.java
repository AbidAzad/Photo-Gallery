...
public class AdminController {
	 ...
	 * @param mainStage passing a reference to the main stage
	 * @author AbidAzad aa2177
	 */	    
    ...
    /**
   	 * Helper Method that throws an alert in the case that something goes wrong. useful for all the try and catch that we will have
   	 * @param title of alert, String.
   	 * @param header of alert, String.
   	 * @param content of alert, String.
   	 * @author DiegoCastellanos dac392
   	 */	      
