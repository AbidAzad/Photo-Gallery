...
public class User implements Serializable{
	...
	/**
	 * main identifier of a user
	 */
	private String username;
	/**
	 * list of albums that the user has 
	 */
	private ArrayList<Album> albums;
	/**
	 *	list of userCreatedTags
	 */
	 ...
	 * @param username for String username to identify user.
	 * @author AbidAzad aa2177
	 */
	 ...
	 * @param newName for Album to be added.
	 * @author AbidAzad aa2177
	 */	
	 ...
	 * @param a ArrayList of Album to be set as the user's albums.
	 * @author AbidAzad aa2177
	 */	
