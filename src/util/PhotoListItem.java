...
/**
 *	Class extends ListCell_Photo_ and is used only for setting up the ListView item in ImageView
 *	@author diegocastellanos
 */
public class PhotoListItem extends ListCell<Photo>{
	/**
	 *	Overides the ListCell_Photo_ method and is used to define the way in which Photo objects are displayed in the ListView 
	 *	@author diegocastellanos
	 */
